...
export function ContactForm({ className }: Props) {
  ...
  return (
    <Form noValidate validated={validated} onSubmit={handleSubmit} className={className}>
      ...
      <Row className={styles['row-controls']}>
        <Col sm={6} className={styles['spacing-mobile']}>
          <Group className="mb-3" controlId="formEmail">
            ...
            <Control.Feedback type="invalid">Please provide a valid email.</Control.Feedback>
          </Group>
        </Col>
        ...
        <Col sm={6} className={styles['spacing-mobile']}>
          <Group className="mb-3" controlId="formCompanyName">
            ...
            <Control.Feedback type="invalid">Please provide a company name.</Control.Feedback>
          </Group>
        </Col>
      </Row>
      ...
      <Row className={styles['row-controls']}>
        <Col className={styles['spacing-mobile']}>
          {isSubmitted && error !== '' && <div className={styles['error-section']}>{error}</div>}

          {isSubmitted && success && <div>Thank you! The SW team will be in touch nearly.</div>}
        </Col>
      </Row>
